...
if __name__ == "__main__":
    json_floder_path = '/home/think/文档/images/img_label_zhaoen/'
    ...
    for json_name in json_names:
        if json_name.endswith('.json'):
            ...
            with open('./data/coco/img_rotate/'+json_name, 'w',encoding='utf-8') as f:
                json.dump(data, f)
            cv2.imwrite('./data/coco/img_rotate/'+json_name.replace('.json','.jpg'), im_rotate)

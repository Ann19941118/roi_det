...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    is_coco = data.endswith('coco.yaml') and nc == 1  # keypoints dataset
...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default='data/coco_keypoints.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--noautoanchor',default='True', action='store_true', help='disable autoanchor check')   #根据图片计算anchors

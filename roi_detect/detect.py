...
def run(weights='yolov5s.pt',  # model.pt path(s)
        source='data/images/train',  # file/dir/URL/glob, 0 for webcam
...
def parse_opt():
    ...
    # parser.add_argument('--source', type=str, default='/home/think/文档/images/20210823', help='file/dir/URL/glob, 0 for webcam')
    parser.add_argument('--source', type=str, default='/home/think/文档/abnormal/ab_aug2', help='file/dir/URL/glob, 0 for webcam')
